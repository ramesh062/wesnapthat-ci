...
<section class="appoinment_part">
	<div class="new_appoinment">
		<div class="common_text">
			<div class="common_text_form">Edit Doctor</div>
		...
		<div class="appoinment_form">
			...
			<div class="custom_input_main">
				<div class="custom_input_box">
					...
					<div class="input_box">
						<input type="text" name="fullname" id="fullname" placeholder="Doctor’s Full Name" class="custom_input" value="<?php echo $doctors->fullname; ?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Email</label>
					<div class="input_box">
						<input type="text" name="email" id="email" placeholder="e.g. johnsmith@email.com" class="custom_input" value="<?php echo $doctors->email; ?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Qualification</label>
					<div class="input_box">
						<input type="text" name="qualification" id="qualification" placeholder="Qualification" class="custom_input" value="<?php echo $doctors->qualification; ?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Speciality</label>
					<div class="input_box">
						<input type="text" name="speciality" id="speciality" placeholder="Speciality" class="custom_input" value="<?php echo $doctors->speciality; ?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Experiance (In year)</label>
					<div class="input_box">
						<input type="number" name="experience" id="experience" placeholder="Experiance" class="custom_input" value="<?php echo $doctors->experience; ?>" min="1" step="0.5">
					</div>
				</div>
				<div class="custom_input_box ">
					...
					<div class="option_menu">
						<div class="input_box select_option">
							<input type="radio" id="male" name="gender" value="male" <?php if($doctors->gender == "male") echo "checked"; ?> >
						...
						<div class="input_box select_option">
							<input type="radio" id="female" name="gender" value="female" <?php if($doctors->gender == "female") echo "checked"; ?>>
				...
				<div class="custom_input_box">
					...
					<div class="input_box">
						<input type="text" name="consultation_charges" id="consultation_charges" placeholder="Consultation Charges" class="custom_input" value="<?php echo $doctors->consultation_charges; ?>">
					</div>
				</div>
				<div class="custom_input_box ">
				...
				<div class="custom_input_box w_full">
					...
					<div class="option_menu timer_select">
						<div class="input_box select_option">
							<input type="radio" id="10_min" name="appointment_time_slots" value="10" <?php if($doctors->appointment_time_slots == "10") echo "checked"; ?>>
							<label class="radio_main" for="10_min">
								<span class="gender_select">10 min</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="radio" id="15_min" name="appointment_time_slots" value="15" <?php if($doctors->appointment_time_slots == "15") echo "checked"; ?>>
							<label class="radio_main" for="15_min">
								<span class="gender_select">15 min</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="radio" id="20_min" name="appointment_time_slots" value="20" <?php if($doctors->appointment_time_slots == "20") echo "checked"; ?>>
							<label class="radio_main" for="20_min">
								<span class="gender_select">20 min</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="radio" id="30_min" name="appointment_time_slots" value="30" <?php if($doctors->appointment_time_slots == "30") echo "checked"; ?>>
							<label class="radio_main" for="30_min">
								<span class="gender_select">30 min</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="radio" id="45_min" name="appointment_time_slots" value="45" <?php if($doctors->appointment_time_slots == "45") echo "checked"; ?>>
							<label class="radio_main" for="45_min">
								<span class="gender_select">45 min</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="radio" id="1_hour" name="appointment_time_slots" value="60" <?php if($doctors->appointment_time_slots == "60") echo "checked"; ?>>
				...
				<div class="custom_input_box w_full">
					...
					<div id="consultation">
						...
						<div class="d-flex align-items-center justify-content-between" id="div_<?php echo $key + 1; ?>">
							<div class="input_box time_input_box">
								<input class="timepicker text-center" name="from_time[]" readonly="true" value="<?php echo  date("h:i A", strtotime($value['from_time'])); ?>" id="from_<?php echo $key + 1; ?>">
							</div>
							<span class="between_word"> To </span> 
							<div class="input_box time_input_box">
								<input class="timepicker text-center" name="to_time[]" readonly="true" value="<?php echo  date("h:i A", strtotime($value['to_time'])); ?>" id="to_<?php echo $key + 1; ?>">
							</div>
				...
				<div class="custom_input_box w_full">
					...
					<div class="option_menu week_select">
						<div class="input_box select_option">
							<input type="checkbox" name="mon" id="mon" value="mon" <?php echo $mon; ?> >
							<label class="radio_main" for="mon">
								<span class="gender_select">Monday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="tue" id="tue" value="tue" <?php echo $tue; ?> >
							<label class="radio_main" for="tue">
								<span class="gender_select">Tuesday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="wed" id="wed" value="wed" <?php echo $wed; ?> >
							<label class="radio_main" for="wed">
								<span class="gender_select">Wednesday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="thu" id="thu" value="thu" <?php echo $thu; ?> >
							<label class="radio_main" for="thu">
								<span class="gender_select">Thursday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="fri" id="fri" value="fri" <?php echo $fri; ?> >
							<label class="radio_main" for="fri">
								<span class="gender_select">Friday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="sat" id="sat" value="sat" <?php echo $sat; ?> >
							<label class="radio_main" for="sat">
								<span class="gender_select">Saturday</span>
							</label>
						</div>
						<div class="input_box select_option">
							<input type="checkbox" name="sun" id="sun" value="sun" <?php echo $sun; ?> >
			...
			<div class="custom_input_main">
				...
				<div class="custom_input_box">
					...
					<div class="input_box">
						<input type="hidden" name="countrycode" id="countrycode" value="<?php echo $doctors->countrycode?>"/> 
						<input type="text" name="mobile" id="mobile" placeholder="Enter mobile number" class="custom_input" value="<?php echo $doctors->countrycode.$doctors->mobile?>"/>
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Address 1</label>
					<div class="input_box">
						<input type="text" name="address1" id="address1" placeholder="Enter address 1" value="<?php echo $doctors->address1?>" class="custom_input">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Address 2</label>
					<div class="input_box">
						<input type="text" name="address2" id="address2" placeholder="Enter address 2" class="custom_input" value="<?php echo $doctors->address2?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Town</label>
					<div class="input_box">
						<input type="text" name="town" id="town" placeholder="Enter town" class="custom_input" value="<?php echo $doctors->town?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">City</label>
					<div class="input_box">
						<input type="text" name="city" id="city" placeholder="Enter city" class="custom_input" value="<?php echo $doctors->city?>">
					</div>
				</div>
				<div class="custom_input_box">
					<label class="input_label">Country</label>
					<div class="input_box">
						<input type="text" name="country" id="country" placeholder="Enter country" class="custom_input" value="<?php echo $doctors->country?>">
					</div>
				</div>
			</div>
			<?php echo form_close(); ?>
		...
		<div class="btn_book">
		<a href="javascript:;" class="common_button" onclick="edit_doctor_details(<?php echo $doctors->id; ?>)">
			<span>Submit</span>
		</a>
		</div>
	</div>
